...
public:
    ...
    //меняет местами элементы массива под индексами index1, index2.
    ...
    //создает массив из n элементов на основе случайных чисел в диапазоне [minValue, maxValue].
    ...
    /*
    Функция CreateInputArray(n, minValue, maxValue) создает массив из n 
    элементов на основе пользовательского ввода чисел в диапазоне [minValue, maxValue].
    */
    ...
    /*
    * создает массив из 
    n элементов чисел в диапазоне [minValue, maxValue]. 
    Функция «спрашивает» у пользователя должны ли данные быть случайными
    */
    ...
    //создает массив из n элементов на основе функции CreateArray(n, minValue, maxValue), 
    vector <int> CreateArray(int n) {
        return CreateArray(n, MIN_VALUE, MAX_VALUE);
    }

    /*
    создает массив из элементов на основе функции CreateArray(n),  количество элементов указывает пользователь.
    */
...
public:
    ...
    //проверяет равны ли элементы a и b.
    ...
    /*
    * создает матрицу m x n на основе случайных чисел в диапазоне [minValue, maxValue].
    */
    ...
    /*
    создает матрицу m x n на основе пользовательского ввода чисел в диапазоне [minValue, maxValue].
    */
    ...
    /*
    создает матрицу m x n чисел в диапазоне [minValue, maxValue]. 
    Функция «спрашивает» у пользователя должны ли данные быть случайными (использует функции CreateRandomArray, CreateInputArray).
    */
    ...
    /*
    создает матрицу m x n на основе функции CreateArray(n, m, minValue, maxValue), 
    */
    ...
    //выводит «шапку» матрицы на экран.
    ...
    //возвращает индексы минимального и максимального элементов матрицы.
...
private:
    /*
    * выводит на экран массив выделяя цветом и текстом минимальный и максимальный элементы.
    */
...
private:
    ...
    //вычисляет среднее арифметическое массива arr.
...
private:
    ...
    //проверяет содержит ли матрица больше негативных элеметов.
    ...
    //заменяет все отрицательные элементы матрицы нулями.
...
class Task46 {
private:
    //выводит элементы с координатами coordMin, coordMax красным и зелеными цветами соответственно.
...
private:
    ...
    //вычисляет сумму модулей в столбце j
    ...
    //вычисляет индекс столбца L-нормы.
...
private:
    ...
    class CalcHide {
    public:
        //умножает матрицу на вектор (без вывода промежуточных вычислений)
    ...
    class CalcPrint {
        private:
            //умножает матрицу на вектор (с выводом промежуточных вычислений)
